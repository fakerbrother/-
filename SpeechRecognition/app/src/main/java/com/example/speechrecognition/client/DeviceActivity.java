package com.example.speechrecognition.client;
...
import com.example.speechrecognition.chat.ChatActivity;
...
public class DeviceActivity extends Activity {
    ...
    private String selectedUuidStr= com.example.speechrecognition.client.ClientService.clientUuid;
    //当前设配配对状态
