...
public class MainActivity extends AppCompatActivity {
    ...
    private void startAcceptService() {
        Intent intent = new Intent(this, com.example.speechrecognition.server.AcceptService.class);
        startService(intent);
    }
    /**
    ...
    private void initView() {
        ...
        lvBle.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(MainActivity.this, com.example.speechrecognition.client.DeviceActivity.class);
